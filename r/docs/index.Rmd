...
- **[v1.1.0 (Mar 25, 2019)](http://ecosheds.org/models/bto/v1.1.0/)**  
...
- **[v1.0.0 (Oct 25, 2018)](http://ecosheds.org/models/bto/v1.0.0/)**  
Recalibrate model using [v1.0 of stream temperature model](http://ecosheds.org/models/stream-temperature/v1.0.1/).
- **[v0.9.0 (Aug 16, 2018)](http://ecosheds.org/models/bto/v0.9.0/)**  
